/*
 * $Id: mdrun.c,v 1.1 2008-06-27 10:50:09 mdd Exp $
 * 
...
#define NFILE asize(fnm)
  ...
  static t_pargs pa[] = {
    ...
    // MDDriver (July 2007) - insert 8 lines
    { "-IMDfreq", FALSE, etINT, {&nstximd},
      "IMD frequency for scanning / sending forces and atom positions" },
    { "-IMDwait", FALSE, etINT, {&gimd_wait},
      "IMD wait mode cause waiting until an IMD message" },
    { "-IMDport", FALSE, etINT, {&gimd_port},
      "IMD port use to listen incoming messages" },
    { "-IMDmsg",  FALSE, etINT, {&gimd_msg},
      "IMD message level" },
    { "-IMDlog",  FALSE, etSTR, {&gimd_log},
      "IMD logfile filename for log" },
